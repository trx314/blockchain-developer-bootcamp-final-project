...
contract autoDonate is Ownable {
...
/// @notice Determine which aToken are allowed for deposit
/// @dev TO DO: implement array of aTokens instead of only one
/// @param token The aToken allowed for deposit
...
function whitelistDonation(address toWhitelist) public onlyOwner() {
...
function whitelistRemove(address toRemove) public onlyOwner() {
